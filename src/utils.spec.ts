...
import { getDirectories, getDirectoryFiles, isFileExists } from "./utils";
...
describe("getDirectoryFiles", () => {
  ...
  context("if directory is not empty", () => {
    context("with nested", () => {
      it("returns 7 items array", async () => {
        await expect(
          ...
          "src/fixtures/Assets/package.json",
          "src/fixtures/Assets/package.json.meta",
